...
module.exports = "<!-- Fixed navbar -->\n<nav class=\"navbar navbar-inverse navbar-fixed-top\">\n  <div class=\"container\">\n    <div class=\"navbar-header\">\n      <button type=\"button\" class=\"navbar-toggle collapsed\" data-toggle=\"collapse\" data-target=\"#navbar\" aria-expanded=\"false\" aria-controls=\"navbar\">\n        <span class=\"sr-only\">Toggle navigation</span>\n        <span class=\"icon-bar\"></span>\n        <span class=\"icon-bar\"></span>\n        <span class=\"icon-bar\"></span>\n      </button>\n      <a class=\"navbar-brand\" routerLink=\"main\">VX</a>\n    </div>\n    <div id=\"navbar\" class=\"navbar-collapse collapse\">\n      <ul class=\"nav navbar-nav\">\n        <li><a routerLink=\"main\">Home</a></li>\n        <li><a href=\"\">About</a></li>\n        <li><a href=\"\">Contact</a></li>\n        </ul>\n\n        <div class=\"navbar-collapse collapse pull-right\">\n            <ul class=\"nav navbar-nav\">\n            <li *ngIf=\"isLoggedIn(); else login\"><a [routerLink]=\"main\" (click)=\"logOut()\">logout</a></li>\n            <ng-template #login><li class=\"pull-right\"><a routerLink=\"login\" class=\"pull-right\">Login</a></li></ng-template>\n            </ul>\n        </div>\n        \n    </div><!--/.nav-collapse -->\n  </div>\n</nav>\n<br>\n<br>\n<br>\n<div class=\"container theme-showcase\" role=\"main\">    \n  <div class=\"jumbotron\">\n    <h1>VX Group</h1>\n    <p>Portal aktuelnih vesti</p>\n  </div>\n\n  <router-outlet></router-outlet>\n\n</div>\n\n"
...
/* harmony import */ var _vest_detalj_vest_detalj_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./vest-detalj/vest-detalj.component */ "./src/app/vest-detalj/vest-detalj.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    { path: 'main/vest/:vestId', component: _vest_detalj_vest_detalj_component__WEBPACK_IMPORTED_MODULE_13__["VestDetaljComponent"] },
    { path: 'main', component: _main_component_main_component_component__WEBPACK_IMPORTED_MODULE_6__["MainComponentComponent"] },
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _vest_detalj_vest_detalj_component__WEBPACK_IMPORTED_MODULE_13__["VestDetaljComponent"]
            ],
            imports: [
...
var MainComponentComponent = /** @class */ (function () {
    function MainComponentComponent(authenticationService, http) {
        this.authenticationService = authenticationService;
        this.http = http;
        this.vest = {
            naslov: "",
    ...
    MainComponentComponent.prototype.loadData = function () {
        ...
        this.http.get("api/vesti", { params: params }).subscribe(function (data) {
            _this.vesti = data["content"];
            _this.numberOfPages = data["totalPages"];
            _this.reset();
        });
    };
    MainComponentComponent.prototype.loadKategorije = function () {
        var _this = this;
        this.http.get("api/kategorije").subscribe(function (data) {
            _this.kategorije = data;
        });
    };
    MainComponentComponent.prototype.loadFilteredData = function () {
        var _this = this;
        ...
        this.http.get("api/vesti/filter", { params: params }).subscribe(function (data) {
    ...
    MainComponentComponent.prototype.save = function () {
        ...
        if (this.vest.id === undefined) {
            this.http
                .post("api/vesti", JSON.stringify(this.vest), { headers: headers })
                .subscribe(function (data) {
                console.log(_this.vest);
                _this.loadData();
            });
        }
        else {
    ...
    MainComponentComponent.prototype.delete = function (vest) {
        var _this = this;
        this.http.delete("api/vesti/" + vest.id).subscribe(function (data) {
            _this.loadData();
        });
    };
    ...
    MainComponentComponent.prototype.changePage = function (x) {
    ...
    MainComponentComponent.prototype.edit = function (v) {
        this.vest = v;
    };
    MainComponentComponent.prototype.byId = function (item1, item2) {
        if (!item1 || !item2) {
            return false;
        }
    ...
    MainComponentComponent = __decorate([
        ...
        __metadata("design:paramtypes", [app_security_authentication_service__WEBPACK_IMPORTED_MODULE_2__["AuthenticationService"],
...
/***/ "./src/app/vest-detalj/vest-detalj.component.css":
/*!*******************************************************!*\
  !*** ./src/app/vest-detalj/vest-detalj.component.css ***!
  \*******************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3Zlc3QtZGV0YWxqL3Zlc3QtZGV0YWxqLmNvbXBvbmVudC5jc3MifQ== */"

/***/ }),

/***/ "./src/app/vest-detalj/vest-detalj.component.html":
/*!********************************************************!*\
  !*** ./src/app/vest-detalj/vest-detalj.component.html ***!
  \********************************************************/
/*! no static exports found */
...
module.exports = "<h1>{{vest.naslov}}</h1>\n<p>{{vest.sadrzaj}}</p>\n\n"

/***/ }),

/***/ "./src/app/vest-detalj/vest-detalj.component.ts":
/*!******************************************************!*\
  !*** ./src/app/vest-detalj/vest-detalj.component.ts ***!
  \******************************************************/
/*! exports provided: VestDetaljComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "VestDetaljComponent", function() { return VestDetaljComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var VestDetaljComponent = /** @class */ (function () {
    function VestDetaljComponent(route, http) {
        this.route = route;
        this.http = http;
        this.vest = {};
    }
    VestDetaljComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.sub = this.route.params.subscribe(function (params) {
            _this.isDataAvailable = false;
            _this.id = +params['vestId']; // (+) konvertuje string 'id' u broj
            //id postavljamo kao path parametar pomocu interpolacije stringa
            _this.http.get("/api/vesti/" + _this.id).subscribe(
    ...
    VestDetaljComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-vest-detalj',
            template: __webpack_require__(/*! ./vest-detalj.component.html */ "./src/app/vest-detalj/vest-detalj.component.html"),
            styles: [__webpack_require__(/*! ./vest-detalj.component.css */ "./src/app/vest-detalj/vest-detalj.component.css")]
        }),
...
module.exports = __webpack_require__(/*! /home/klostur/web/FinalExamExercise/projekat/client/src/main.ts */"./src/main.ts");
